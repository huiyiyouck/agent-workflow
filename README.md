...
4. 如果是空项目，先不要手工创建 `project-context.md` 或 `docs/progress/INDEX.md`，第一次需要进入团队模式时说：`执行 Bootstrap 初始化流程`，由 Bootstrap 创建。
5. Bootstrap 会初始化 `docs/progress/INDEX.md`、`docs/progress/iterations/`、`docs/progress/roles/`，但不会默认创建迭代。
